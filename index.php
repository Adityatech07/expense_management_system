    ...
    <div class="container">
        ...
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <div class="new-account">
                ...
                <a href="templates/sign-up.php" style="text-decoration: none;"><span style="color: rgba(5, 0, 255, 0.81); font-weight: bolder; font-family: 'Source Sans Pro';">Sign Up Now</span></a>
            </div>
